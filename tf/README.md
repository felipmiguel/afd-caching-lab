...
```
curl "https://nubesgen.com/demo.zip?iactool=TERRAFORM&region=eastus&application=SPRING_APPS.standard&runtime=DOCKER&database=NONE.free&addons=storage_blob&network=VIRTUAL_NETWORK" | tar -xzvf -
```
